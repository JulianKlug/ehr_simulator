...
from ehr_simulator.db import config_history, study_identity
...
def create_or_fetch_schedule(
    ...
    *,
    ...
    starting-arm count, generation and insert run under one
    ``BEGIN IMMEDIATE`` so concurrent enrolments cannot share a count.
    No route calls this in S11c.
